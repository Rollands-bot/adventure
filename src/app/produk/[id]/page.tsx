                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-brand-500 outline-none ${
                        startDate ? "text-gray-900" : "text-transparent"
                      }`}
                    />
                    {!startDate && (
                      <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-sm pointer-events-none flex items-center gap-1.5">
