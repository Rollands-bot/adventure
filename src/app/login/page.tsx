      ...
      <div className="flex items-center justify-center px-4 pt-28 md:pt-32 pb-12">
        ...
        >
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border border-gray-200 bg-white hover:bg-gray-50 text-gray-700 font-medium py-3 rounded-xl transition-all disabled:opacity-60 disabled:cursor-not-allowed"
          >
            <svg
              className={`w-5 h-5 ${isGoogleLoading ? "animate-spin" : ""}`}
              viewBox="0 0 24 24"
            >
