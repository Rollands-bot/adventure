        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Punya pertanyaan? Jangan ragu untuk menghubungi kami melalui berbagai渠道 di bawah ini
            </p>
          </div>
          ...
          <div className="text-center mt-16">
            <p className="text-gray-600 mb-4">Atau hubungi kami langsung melalui WhatsApp</p>
            <Link
