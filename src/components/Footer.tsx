...
const Footer = () => {
  ...
  const footerLinks = {
    produk: [
      { href: "/produk", label: "Tenda" },
      { href: "/produk", label: "Carrier" },
      { href: "/produk", label: "Sleeping Bag" },
      { href: "/produk", label: "Aksesoris" },
    ],
    perusahaan: [
      { href: "/cara-kerja", label: "Cara Kerja" },
      { href: "/kontak", label: "Tentang Kami" },
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 md:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-sm">
              Partner terbaik untuk petualangan outdoor Anda. Sewa peralatan 
              berkualitas dengan harga terjangkau dan proses yang mudah.
            </p>
          ...
          {/* Produk Links */}
          <div>
            <h4 className="font-bold text-lg mb-6">Produk</h4>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              <li>
                <a
                  href="https://maps.app.goo.gl/iTUe8Wqyuf2oB3bg8?g_st=iw"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                >
                  ...
                  <span>Jl. Raya Serang No.Km.10 15810 Curug Banten</span>
                </a>
              </li>
              <li className="flex items-center">
                ...
                <span>+62 851-2996-6730</span>
              </li>
              <li className="flex items-center">
                <svg className="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>hello@ruangaktif.com</span>
              </li>
            </ul>
          </div>
        </div>
